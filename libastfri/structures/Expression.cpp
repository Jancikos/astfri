...
BinaryExpression::BinaryExpression(Expression *left, BinaryOperators op, Expression *right)
    : left(left), op(op), right(right) {}

UnaryExpression::UnaryExpression(UnaryOperators op, Expression *arg) : op(op), arg(arg) {}

ParamRefExpression::ParamRefExpression(ParameterDefinition *parameter) : parameter(parameter) {}

VarRefExpression::VarRefExpression(VariableDefintion *variable) : variable(variable) {}
...
UnknownExpression::UnknownExpression(std::string message) : message(std::move(message)) {}
