...
DeclarationAndAssigmentStatement::DeclarationAndAssigmentStatement(
    ...
    : DeclarationStatement(declaration), expression(expression) {}
...
IfStatement::IfStatement(Expression *condition, CompoundStatement *thenBody,
                         CompoundStatement *elseBody)
    : ConditionalStatement(condition), thenBody(thenBody), elseBody(elseBody) {}
...
DoWhileLoopStatement::DoWhileLoopStatement(Expression *condition,
                                           CompoundStatement *body)
    : LoopStatement(condition, body) {}

ForLoopStatement::ForLoopStatement(ExpressionStatement *init,
                                   Expression *condition,
                                   ExpressionStatement *step,
                                   CompoundStatement *body)
    : LoopStatement(condition, body), init(init), step(step) {}
